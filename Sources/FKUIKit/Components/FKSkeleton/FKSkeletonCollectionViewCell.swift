//
// FKSkeletonCollectionViewCell.swift
//

import UIKit

/// A dedicated collection cell for skeleton layouts. Register with its own reuse identifier, separate
/// from real content cells.
