...
public extension FKButton {
  ...
  struct CornerStyle: Equatable, Sendable {
    ...
    public nonisolated(unsafe) static let `default` = CornerStyle()
  }
  ...
  struct Border: Equatable, Sendable {
    ...
    public nonisolated(unsafe) static let `default` = Border()
    public nonisolated(unsafe) static let clear = Border()
  }
